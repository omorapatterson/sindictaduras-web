...
export class PrisionerosPoliticosService {
    ...
    constructor(
        ...
        private http: ErrorHandlingHttpService) {
            this.apiEndpoint = this.configService.apiUrl + this.configService.config.apiConfigs.prisionerosPoliticos.apiEndpoint;
    }

    getPrisionerosPoliticos(): Observable<any> {
